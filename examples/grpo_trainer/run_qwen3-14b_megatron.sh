...
project_name='qwen3-14B-DAPO'
exp_name='DAPO-Qwen3-14B-megatron-0715'
...
mkdir -p $MCORE_MODEL_PATH



# convert QWen3-235b-A22b to dist ckpt of mcore. Conversion process will take about 4 hours
# python scripts/converter_hf_to_mcore.py --hf_model_path $MODEL_PATH --output_path $MCORE_MODEL_PATH
CKPTS_DIR=$RAY_DATA_HOME/ckpt/${project_name}/${exp_name}
TRAIN_FILE=/mnt/lustre/share_data/datasets/gsm8k/train.parquet
TEST_FILE=/mnt/lustre/share_data/datasets/gsm8k/test.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.log_val_generations=10 2>&1 | tee verl_qwen3-14b_megatron_0715.log
